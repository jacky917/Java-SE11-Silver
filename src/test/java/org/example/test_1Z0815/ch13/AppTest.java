...
public class AppTest
     ...
     * 4.（查看array4）重新賦值不會有原長度陣列空位的情況發生，會報錯
     */
...
//        System.out.println(array[1][3]);
        ...
        System.out.println(array4[0][4]);
        // java.lang.ArrayIndexOutOfBoundsException
        // 已經重新賦值成長度為二的陣列了
        System.out.println(array4[1][3]);
    }
     ...
     * 複習：查看總結
     * 總結：
     * 1.Math.pow 的入參是 double 返回也是 double。
     * 2.Math.round 四捨五入。
     */
    public void test_q46() {
        int num = 2;
        System.out.println(Math.pow(3.1, num));
        int result = (int) Math.round(Math.pow(3.1, num));
     ...
     * 需要補足知識：淺拷貝
     * 複習：查看以下代碼
     * 總結：clone只會深拷貝一層，如果數組內又包含對象，只會是引用。
     */
